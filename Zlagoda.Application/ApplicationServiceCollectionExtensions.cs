...
public static class ApplicationServiceCollectionExtensions
{
    public static IServiceCollection AddApplication(this IServiceCollection services)
    {
        ...
        services.AddSingleton<ISalesSummaryRepository, SalesSummaryRepository>();
        services.AddSingleton<ISalesSummaryService, SalesSummaryService>();
    ...
    public static void AddLazy(this IServiceCollection services)
    {
        ...
        services.AddTransient<Lazy<IProductRepository>>(provider =>
            new Lazy<IProductRepository>(provider.GetRequiredService<IProductRepository>));
        services.AddTransient<Lazy<IStoreProductService>>(provider =>
            new Lazy<IStoreProductService>(provider.GetRequiredService<IStoreProductService>));
    }
}